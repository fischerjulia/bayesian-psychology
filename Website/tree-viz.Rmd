...
sequence_data <- reshape(
  data = convo_data[, c("id", "turn", "turn_type")],
  timevar = "turn",           
  idvar = "id",
  v.names = "turn_type",
  direction = "wide",
...
alphabet <- c("Elaboration", "HedgedDisclosure", "Reflection", "Advice", "Question", "Acknowledgement")
labels <- c("Elaboration", "HedgedDisclosure", "Reflection", "Advice", "Question", "Acknowledgement")
...
sequences <- seqdef(sequence_data,  
                   ...
                   labels = labels,
                   xtstep = 25,
                   cpal=c(Elaboration, HedgedDisclosure, Reflection, Advice, Question, Acknowledgement))
```
...
seqIplot(sequences,
         with.legend = "right",
         cex.legend = 0.6,
         main = "Support Conversation Sequences")
```
